...
<div class="hiraola-product_area">
    <div class="container">
        @foreach ($groupedProducts as $categoryId => $group)
        <div class="row">
            <div class="col-lg-12">
                <div class="hiraola-section_title">
                    <h4>{{ $group['category']->name }}</h4> <!-- Kategori adını kullanabilirsiniz -->
                </div>
            </div>
            <div class="col-lg-12">
                    ...
                    <div class="slide-item">
                        <div class="single_product">
                            <div class="product-img">
                                <a href="{{ route('page.product.detail', $product->slug) }}">
                                ...
                                <div class="add-actions">
                                    <!-- Ekleme eylemleri buraya eklenebilir -->
                                </div>
                            </div>
